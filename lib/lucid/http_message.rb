module Lucid
  ...
  class HttpMessage < Message
    ...
    class << self
      ...
      def http_method
        HttpMessage::GET # Default to GET
      end

      def get?
        http_method == HttpMessage::GET
      end

      def post?
        http_method == HttpMessage::POST
      end
      ...
      def merge_app_state (params)
        if HttpMessage.app_context.nil?
          params
        else
          HttpMessage.app_context.merge_state(
             get? ? params : {}
          )
        end
      end
